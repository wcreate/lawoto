...
type Question struct {
	...
	Attachment        string    `orm:"type(text);null"`                   //
	Thumbnails        string    `orm:"index"`                             // Original remote file
	ThumbnailsLarge   string    `orm:"index"`                             // 200x300
	ThumbnailsMedium  string    `orm:"index"`                             // 200x150
	ThumbnailsSmall   string    `orm:"index"`                             // 70x70
